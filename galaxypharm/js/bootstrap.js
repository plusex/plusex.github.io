...
$('.hover-elem').on('mouseover', function () {
...
$('.hover-menu').on('mouseover', function () {
  $('.hover-menu').addClass('show');
  $(this).on('mouseout ', function () {
    $('.hover-menu').removeClass('show');
    $('.hover-elem a').css({
...
$('.nav-item .nav-hover').on('mouseover', function () {
  $('.hover-cart').addClass('show');
  $(this).css({
    color: '#297aff'
  });
  ...
  $(this).on('mouseout', function () {
    $('.hover-cart').removeClass('show');
    $('.nav-item .nav-hover').css({
...
$('.hover-cart').on('mouseover', function () {
  $('.hover-cart').addClass('show');
  $('.nav-item .nav-hover').css({
    color: '#297aff'
  });
  $('.nav-item .nav-hover svg').css({
    display: 'none '
  });
  $('.hover-element').css({
    display: 'inline-block'
